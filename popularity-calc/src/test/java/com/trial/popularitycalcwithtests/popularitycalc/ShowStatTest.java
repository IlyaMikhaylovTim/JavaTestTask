...
public class ShowStatTest {
    ...
    public void validGenreIdRequest() throws Exception {
        ...
        assertThat(restTemplate.getForObject("http://localhost:" + port + "/showStat/35",
    ...
    public void invalidGenreIdRequest() throws Exception {
        ...
        assertThat(restTemplate.getForObject("http://localhost:" + port + "/showStat/34",
                String.class)).contains(content);
    }

    @Test
    public void shouldContainTemplateResultMessage() throws Exception {
        while(restTemplate.getForObject("http://localhost:" + port + "/showStat/35",
